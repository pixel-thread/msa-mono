...
-- CreateEnum
CREATE TYPE "payment_type" AS ENUM ('SUBSCRIPTION', 'DONATION', 'EVENT_FEE', 'BANK_INTEREST', 'FAMILY_CONTRIBUTION');
...
-- CreateIndex
CREATE INDEX "subscription_plans_associationId_idx" ON "subscription_plans"("associationId");

-- CreateIndex
CREATE UNIQUE INDEX "subscription_plans_associationId_name_key" ON "subscription_plans"("associationId", "name");

-- CreateIndex
CREATE INDEX "subscription_plan_versions_planId_idx" ON "subscription_plan_versions"("planId");
...
-- CreateIndex
CREATE INDEX "subscription_billing_history_subscriptionId_idx" ON "subscription_billing_history"("subscriptionId");
...
-- AddForeignKey
ALTER TABLE "subscription_plans" ADD CONSTRAINT "subscription_plans_associationId_fkey" FOREIGN KEY ("associationId") REFERENCES "associations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "subscription_plans" ADD CONSTRAINT "subscription_plans_memberTypeId_fkey" FOREIGN KEY ("memberTypeId") REFERENCES "member_types"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "subscription_plan_versions" ADD CONSTRAINT "subscription_plan_versions_planId_fkey" FOREIGN KEY ("planId") REFERENCES "subscription_plans"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "subscriptions" ADD CONSTRAINT "subscriptions_planVersionId_fkey" FOREIGN KEY ("planVersionId") REFERENCES "subscription_plan_versions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "subscription_billing_history" ADD CONSTRAINT "subscription_billing_history_planVersionId_fkey" FOREIGN KEY ("planVersionId") REFERENCES "subscription_plan_versions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
